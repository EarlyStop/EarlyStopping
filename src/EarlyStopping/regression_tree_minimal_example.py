...
# Generate Y on train and test set on the circular process:
# It is simply a circle in two dimensions X1, X2
...
# The f and the noise_train are given as input to calculate theoretical quantities, which are not important for you yet:
