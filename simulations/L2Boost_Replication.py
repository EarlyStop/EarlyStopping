...
results_beta_3 = simulation_beta_3.run_simulation_L2_boost(
                        max_iteration = 50, data_set_name="L2_boost_beta_15"
                      )
results_beta_2 = simulation_beta_2.run_simulation_L2_boost(
                        max_iteration = 100, data_set_name="L2_boost_beta_60"
                      )
results_beta_1 = simulation_beta_1.run_simulation_L2_boost(
                        max_iteration = 200, data_set_name="L2_boost_beta_90"
                      )

results_beta_15 = simulation_beta_15.run_simulation_L2_boost(
                        max_iteration = 50, data_set_name="L2_boost_beta_15"
                      )
results_beta_60 = simulation_beta_60.run_simulation_L2_boost(
                        max_iteration = 100, data_set_name="L2_boost_beta_60"
                      )
results_beta_90 = simulation_beta_90.run_simulation_L2_boost(
                        max_iteration = 200, data_set_name="L2_boost_beta_90"
                      )
...
data = [relative_efficiency_discrepancy_beta_3,
...
fig_dir = ""
create_custom_boxplot(data, labels, y_lim_lower = 0.1, y_lim_upper=1.1, fig_dir=fig_dir, name='L2_boost_relative_efficiencies_discrepancy')
...
data = [relative_efficiency_residual_ratio_beta_3,
