...
ax.plot(range(0, max_iteration + 1), model_gravity.strong_bias2, color="blue", linewidth=1.5, label=r"$a_m(g^*)$")
ax.plot(range(0, max_iteration + 1), model_gravity.strong_variance, color="red", linewidth=2, label=r"$s_m$")
...
# Plot elements with matching colors and styles
ax.plot(range(0, max_iteration + 1), model_gravity.weak_bias2, color="blue", linewidth=1.5, label=r"$a_m(g^*)$")
ax.plot(range(0, max_iteration + 1), model_gravity.weak_variance, color="red", linewidth=2, label=r"$s_m$")
