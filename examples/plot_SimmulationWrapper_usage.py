"""
Usage example of the SimulationWrapper class
============================================
...
design_smooth, response_noiseless_smooth, true_signal_smooth = es.SimulationData.diagonal_data(sample_size=1000, type = 'smooth')
